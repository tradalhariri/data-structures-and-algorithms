...
const sortByPrice = (arr) => {
  ...
  return arr.sort((obj1, obj2) => {
    // return  (obj1.price<obj2.price ? -1:(obj1.price>obj2.price ? 1:0));
...
const alphabetizeBetter = (arr) => {
  ...
  return arr.sort((str1, str2) =>{
    ...
    if((str1.toUpperCase() === str2.toUpperCase()) ) {
      ...
      return (str1.toUpperCase() < str2.toUpperCase() ? -1:1);
    }
  });
};
...
const sortNumbersByLength = (arr) => {
  ...
  return arr.sort((num1, num2) => {
    return (Math.abs(num1).toString().length - Math.abs(num2).toString().length);
  })
};
...
const sortPeople = (arr) => {
  // Solution code here...
  return arr.sort((obj1, obj2) => {
    return (obj1.lastName < obj2.lastName ? -1 : 1)
  })
...
const sortSchedule = (arr) => {
  ...
  return arr.sort((day1, day2) => {
    ...
    else if(days.indexOf(day1.dayOfWeek) === days.indexOf(day2.dayOfWeek)){
      if(day1.start === day2.start){
        return ((Number(day1.end) - Number(day1.start)) - (Number(day2.end) - Number(day2.start)) )

      }else{
        return Number(day1.start) - Number(day2.start)
      }
